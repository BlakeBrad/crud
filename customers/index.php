<?php
    Session_start();
		if($_SESSION['lvl_acess'] != 0){require_once('functions.php');	  }
	index();
?>	
		...
		<tbody>	
			...
			<tr>			
				...
				<td class="actions text-right">	
					...
					<a href="edit.php?id=<?php echo $customer['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-user-edit"></i> Editar</a>		
